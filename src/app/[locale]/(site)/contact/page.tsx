...
export default async function LocalizedContactPage({ params: paramsPromise }: ContactPageProps) {
  ...
  return (
    <main>
      {/* Hero Section - Dark Background (Navy) */}
      <section className="section-spacing-lg bg-navy text-white">
        <div className="container-wide">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-on-scroll fade-in-up">
              {t.contact.hero.title}
            </h1>
            <p className="text-xl md:text-2xl text-slate-300 leading-relaxed animate-on-scroll fade-in-up stagger-1">
      ...
      <section className="section-spacing-lg bg-slate-50">
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-white p-8 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow duration-200 text-center animate-on-scroll scale-in" style={{ animationDelay: `${index * 100}ms` }}>
          ...
          <div className="text-center mt-12 animate-on-scroll fade-in-up stagger-3">
            <LocalizedLink
              href="/services"
